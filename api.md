...
# Profile creation
    - Create Profile / POST / https://api.gotinder.com/v1/profile
    - My Profile / GET / https://api.gotinder.com/v1/profile
    - Feed / GET / https://api.gotinder.com/v1/recs/core?locale=en&duos=0

# Notifications
    - Notifications / PUT / https://api.gotinder.com/v1/push/notifications?locale=en
...
# Connections
    ...
    - My Received Request / GET / https://api.gottinder.com/v1/connections/received
    - My Sent Request / GET / https://api.gottinder.com/v1/connections/sent
